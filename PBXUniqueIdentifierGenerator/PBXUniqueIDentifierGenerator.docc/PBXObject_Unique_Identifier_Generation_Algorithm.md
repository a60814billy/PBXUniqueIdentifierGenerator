...
*   **Random Seed**: A random value is generated using `arc4random()` and masked to 24 bits (0xFFFFFF). This value remains constant for all IDs generated by this process instance.
